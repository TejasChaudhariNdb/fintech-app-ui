...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-[#0B0E14] flex flex-col items-center justify-center p-4 overflow-hidden relative transition-colors duration-300">
      ...
      {/* Existing User Login Banner — high visibility */}
      <div className="w-full max-w-md mb-4 z-10">
        <Link
          href="/login"
          className="flex items-center justify-between gap-3 px-5 py-3.5 rounded-2xl bg-gradient-to-r from-neutral-200/20 to-neutral-300/20 dark:from-white/5 dark:to-white/10 border border-neutral-200/50 dark:border-white/5 hover:from-neutral-200/30 hover:to-neutral-300/30 dark:hover:from-white/10 dark:hover:to-white/15 transition-all duration-200 group">
          <div className="flex items-center gap-3">
            <div className="bg-neutral-200 dark:bg-white/10 p-1.5 rounded-lg">
